        ...
        return Stream.of(
                ...
                Arguments.of("Comparable <",
                        ...
                        new Ast.Expr.Binary("<",
                                ...
                                new Ast.Expr.Literal(BigDecimal.TEN)
                        ),
                        init(new Ast.Expr.Binary("<",
                                init(new Ast.Expr.Literal(BigDecimal.ONE), ast -> ast.setType(Environment.Type.DECIMAL)),
                                init(new Ast.Expr.Literal(BigDecimal.TEN), ast -> ast.setType(Environment.Type.DECIMAL))
                        ), ast -> ast.setType(Environment.Type.BOOLEAN))
                ),
